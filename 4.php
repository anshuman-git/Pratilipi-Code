<?php 
   ...
   if(!isset($_COOKIE['page4'])) {
       setCookie('page4', 'yes', time()+(60*3));
       mysqli_query ($con, "update fourth_page_count set count = count+1");
   }
   ?>
<!DOCTYPE html>
<html lang="en">
   <head>
      <title>The Christmas the lights went out</title>
      <meta charset="utf-8">
   ...
   <body>
         ...
         <nav class="navbar navbar-expand-lg navbar-dark" >
            ...
            <div id="navigation" class="collapse navbar-collapse flex-column" >
               ...
               <?php
                  ...
                  $sql = "SELECT count from fourth_page_count";
      ...
      <header class="blog-post-header">
         <h2 class="title mb-2">The Christmas the lights went out</h2>
         <div class="meta mb-3"><span class="date">Published 3 months ago</span><span class="time">5 min read</span></div>
      </header>
      <div class="blog-post-body">
      <figure class="blog-banner">
         <a href="https://made4dev.com"><img class="img-fluid" src="blog_images/4.jpg" alt="image"></a>
      </figure>
      <p>Tom Jankowitz took his coat off and threw it onto the seat in the airport lounge. He sat down and opened up his laptop computer, keeping one eye on the small television which showed the departure times of all the flights from the airport.
      ...
      <nav class="blog-nav nav nav-justified my-5">
         <a class="nav-link-prev nav-item nav-link rounded-left" href="3.php">Previous<i class="arrow-prev fas fa-long-arrow-alt-left"></i></a>
         <a class="nav-link-next nav-item nav-link rounded-right" href="5.php">Next<i class="arrow-next fas fa-long-arrow-alt-right"></i></a>
      </nav>
